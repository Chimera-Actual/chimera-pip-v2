...
COMMENT ON INDEX idx_user_presence_user_id IS 'Optimize presence lookups';
COMMENT ON INDEX idx_user_activities_user_id_created IS 'Optimize activity feeds';
COMMENT ON INDEX idx_widget_instance_settings_widget_user IS 'Optimize widget settings queries';
COMMENT ON INDEX idx_user_analytics_user_timestamp IS 'Optimize analytics queries by user and time';